(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_0d6a55._.js", {
...
const createUserAdmin = async (userData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/admin`, userData);
        return response.data;
    } catch (error) {
        throw error;
    }
...
function Login() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])({
                email,
                password
            });
...
_s(Login, "21BAdl1Ae2KeQi9vUiAmbCNreSk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_0d6a55._.js.map